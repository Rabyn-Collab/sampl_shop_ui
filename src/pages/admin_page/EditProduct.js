            ...
            <div className="space-y-7 flex flex-col ">
              ...
              <div>
                ...
                <div className='border border-gray-600 h-[150px] my-1 w-full'>
                  {formik.values.preview !== null ? <img src={formik.values.preview} alt="" className='object-cover h-full w-full' /> : <img src={`${baseUrl}${data.product_image}`} alt="" className='object-cover h-full w-full' />}
                </div>
              </div>
